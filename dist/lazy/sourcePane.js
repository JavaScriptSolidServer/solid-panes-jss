...
export const sourcePane = {
  ...
  label: function (subject, context) {
    ...
    if (dominated3) {
      ...
      if (dominated3.includes('text/') || dominated3.includes('application/json') || dominated3.includes('application/ld+json') || dominated3.includes('application/xml') || dominated3.includes('turtle') || dominated3.includes('n3')) {
        return 'Source';
      }
    }
    return null;
...
//# sourceMappingURL=sourcePane.js.map